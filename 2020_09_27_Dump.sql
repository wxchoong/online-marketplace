...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `new_order`(createDate DATETIME, Cname VARCHAR(140), addr VARCHAR(140), ph VARCHAR(140), shipName VARCHAR(140), shipAddr VARCHAR(140), shipPh VARCHAR(140), msg VARCHAR(140), cust_mail VARCHAR(140))
BEGIN
...
-- Dump completed on 2020-09-27  2:52:05
