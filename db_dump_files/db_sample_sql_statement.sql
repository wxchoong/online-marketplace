...
call add_order('superuser@inserted.com'], now(), 'Mr Aaron Seah', 'BLK 123 NUS SOC #07-11', 999123, 93921111,"Packing", "100", DATE_ADD(now(), INTERVAL 3 DAY), "call upon arrival", 3,'Aaron Seah', '5548274139320123', 1, DATE_ADD(CURDATE(), INTERVAL 7 DAY));